        ...
        <div >
            <div className="flex justify-around gap-40 items-center  border border-slate-100 p-2 mb-4 rounded-2xl  ">
                <div className="flex justify-between gap-3 items-center">
                    <img src={selected.icon} className=" w-12 h-10 object-cover object-top rounded-2xl" alt="icon" />
                ...
                <div onClick={()=>handleRemoveStack(selected)} className="text-[25px] text-[#94A3B8] ">
