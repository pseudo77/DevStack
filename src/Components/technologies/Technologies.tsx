...
import { theme, type Itechnology } from "../type/Type";
...
const Technologies = ({promise}:ItechnologyProps) => {
    ...
    return (
        <div>
            ...
            <div className="max-lg:text-center container mx-auto px-5 md:px-8 leading-12 ">
                <h1 className="font-extrabold max-md:text-[24px] text-[36px]  tracking-[-0.9px]">Explore the <span className={`${theme.brandGradient} bg-clip-text text-transparent`} >Technologies</span></h1>
